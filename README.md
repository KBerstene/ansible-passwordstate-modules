...
As of commit 67f112b54ebe119b670b88914521909bd20a0d2a the required version of Ansible is 2.21.0 or later.  This is due to a structural change where the modules were reworked into action plugins, allowing them to return data as ephemeral variables and not Ansible facts by default.
